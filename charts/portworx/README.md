...
|--------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|
| `imageVersion` | Version of the PX image | 3.3.1.3 |
| `pxOperatorImageVersion` | Version of the PX operator image | 25.3.0 |
...
| `instanceVolumeK8sUpgrade` | Enable support for kubernetes upgrades for Anthos cluster on EC2 instance with ephemeral volumes. Setting this also enables S&P | false |
